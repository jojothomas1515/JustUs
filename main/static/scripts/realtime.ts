...
sio.addEventListener("signal", (data: any) => {
    const res = JSON.parse(data);
})

sio.addEventListener("answer", async (data: any) => {
...
sio.addEventListener("offer", async (data: any) => {
    const res = JSON.parse(data);
...
async function answerCall(res: any) {
